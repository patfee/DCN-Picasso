...
layout = html.Div([html.H4("Page 1 – Sub B"), html.P("Initializing …")])
...
try:
    ...
    if height_df.empty or outreach_df.empty:
        layout = html.Div([
            ...
            html.P("No matrix CSVs found in /data folder.")
        ])
    else:
        ...
        def _update_chart(main_factor, fold_factor, concavity_scale):
            ...
            info = (f"Main-jib subdivision: {main_factor}× • Folding-jib subdivision: {fold_factor}× • "
